...
<h2 align="center">MoneyPrinterPlus 优化版</h2>
...
**它可以：自动把视频发布到抖音,快手,小红书,视频号,B站,以及 TikTok / Facebook / YouTube / Instagram 上。**

赚钱从来没有这么容易过!

觉得有用的朋友，请给个star! ![Github stars](https://img.shields.io/github/stars/ddean2009/MoneyPrinterPlus.svg)

> 本仓库为 [ddean2009/MoneyPrinterPlus](https://github.com/ddean2009/MoneyPrinterPlus) 的优化 fork · [leohux/MoneyPrinterPlus](https://github.com/leohux/MoneyPrinterPlus)  
> 增强：Stable Diffusion 生图成片 · 成片导出发布素材 · 国外平台自动发布（TikTok / Facebook / YouTube / Instagram）
...
# 更新列表
* 20260827 【本仓库】打通 Stable Diffusion 生图成片；多平台发布新增 TikTok / Facebook / YouTube / Instagram。
...
- [x] 支持本地语音字幕识别模型
- [x] 视频批量自动发布到各个视频平台,支持抖音，快手，小红书，视频号，B站，以及 TikTok / Facebook / YouTube / Instagram
- [x] 接入stable diffusion，AI生图，合成视频
...
本仓库还支持国外平台：**TikTok、Facebook Reels、YouTube、Instagram**（发布页底部「国外平台」勾选，浏览器需已登录）。
